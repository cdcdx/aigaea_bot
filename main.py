        ...
        while True:
            ...
            answer = select(
                ...
                choices=[
                    ...
                    Choice("🔥 Gaea tasks - snftmint",          'gaea_clicker_snftmint',           shortcut_key="t"),
                    Choice("🔥 Gaea tasks - snftinfo",          'gaea_clicker_snftinfo',           shortcut_key="u"),
                    Choice("🔥 Gaea tasks - snftoblate",        'gaea_clicker_snftoblate',         shortcut_key="v"),
                    Choice("🔥 Gaea tasks - anftmint",          'gaea_clicker_anftmint',           shortcut_key="w"),
                    Choice("🔥 Gaea tasks - anftinfo",          'gaea_clicker_anftinfo',           shortcut_key="x"),
                    Choice("🔥 Gaea tasks - anftoblate",        'gaea_clicker_anftoblate',         shortcut_key="y"),
                    Choice("🚀 Gaea tasks - fundspooling",      'gaea_clicker_fundspooling',       shortcut_key="z"),
