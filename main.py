...
from src.functions import (
    ...
    gaea_clicker_era3info, gaea_clicker_earninfo, gaea_clicker_referralreword, 
    gaea_clicker_openblindbox, gaea_clicker_invitereward, gaea_clicker_claimrewards,
...
MODULE_MAPPING = {
    ...
    'gaea_clicker_claimrewards':   gaea_clicker_claimrewards,
        ...
        while True:
            ...
            answer = select(
                ...
                choices=[
                    ...
                    Choice("🔥 Gaea tasks - invitereward",    'gaea_clicker_invitereward',    shortcut_key="u"),
                    Choice("🔥 Gaea tasks - claimrewards",    'gaea_clicker_claimrewards',    shortcut_key="c"),
