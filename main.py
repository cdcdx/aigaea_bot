        ...
        while True:
            ...
            answer = select(
                ...
                choices=[
                    ...
                    Choice("🚀 Gaea tasks - earninfo",          'gaea_clicker_earninfo',           shortcut_key="l"),
                    Choice("🔥 Gaea tasks - referralreword",    'gaea_clicker_referralreword',     shortcut_key="m"),
                    Choice("🔥 Gaea tasks - openblindbox",      'gaea_clicker_openblindbox',       shortcut_key="n"),
                    Choice("🔥 Gaea tasks - invitereward",      'gaea_clicker_invitereward',       shortcut_key="o"),
                    Choice("🔥 Gaea tasks - inviteclaimed",     'gaea_clicker_inviteclaimed',      shortcut_key="p"),
                    Choice("🔥 Gaea tasks - emotionreward",     'gaea_clicker_emotionreward',      shortcut_key="q"),
                    Choice("🔥 Gaea tasks - emotionclaimed",    'gaea_clicker_emotionclaimed',     shortcut_key="r"),
                    Choice("🔥 Gaea tasks - choicereward",      'gaea_clicker_choicereward',       shortcut_key="s"),
                    Choice("🔥 Gaea tasks - choiceclaimed",     'gaea_clicker_choiceclaimed',      shortcut_key="t"),
                    Choice("🔥 Gaea tasks - snftmint",           'gaea_clicker_snftmint',            shortcut_key="u"),
                    Choice("🔥 Gaea tasks - snftinfo",           'gaea_clicker_snftinfo',            shortcut_key="v"),
                    Choice("🔥 Gaea tasks - snftoblate",         'gaea_clicker_snftoblate',          shortcut_key="w"),
                    Choice("🔥 Gaea tasks - anftmint",           'gaea_clicker_anftmint',            shortcut_key="x"),
                    Choice("🔥 Gaea tasks - anftinfo",           'gaea_clicker_anftinfo',            shortcut_key="y"),
                    Choice("🔥 Gaea tasks - anftoblate",         'gaea_clicker_anftoblate',          shortcut_key="z"),
                    # Choice("🔥 Gaea tasks - upgradeNFT",      'gaea_clicker_upgradenft',         shortcut_key="x"),
